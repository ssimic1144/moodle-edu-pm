...
alg_group_1 = alg_df[alg_df.final < 0.5]
...
alg_group_1.to_csv("data/alg_group_1.csv", index=False)
...
under_alg_group_1 = under_alg_df[under_alg_df.final < 0.5]
...
under_alg_group_1.to_csv("data/under_alg_group_1.csv", index=False)
